...
document.getElementById("random-room-btn").addEventListener("click", async function () {
  ...
  modalBody.innerHTML = `
    ...
    `;
  const previewContainer = document.getElementById("peview-container");
  previewContainer.appendChild(reviews);
  console.log(document.getElementById("peview-container"));
